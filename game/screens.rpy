...
## SFIO say screen animation - not used?
...
screen say(who, what):
    ...
    add SideImage() xalign 0.15 yalign 0.7
...
style window:
    ...
    #quick fix for the pause fonction calling say screen ??
...
screen navigation():
    ...
    vbox:
        ...
        if main_menu:
            ...
            if superdev == True:
                textbutton _("Dev Start") action Start() activate_sound "sounds/scan.ogg"
...
screen main_menu():
    ...
    add "starsmid u2d"
    add "starsbig u2d"  
    add "images/spacenet_logo.png":
        #align (0.65, 0.5) #at truecenter
        align (0.5,0.5)
    
    
    
    
    add "shadow" at truecenter
        ...
        vbox:
            ...
            vbox:
                ...
                if superdev == True:
                    ...
                    #    textbutton _("Allow OpenGL Resize") action ToggleVariable("config.gl_resize", true_value=True, false_value=False)
                        
                    null height 10
                    vbox:
                        style_prefix "radio"
                        label _("GL Powersave")    
                        textbutton _("Powersave") action Preference("gl powersave", True)
                        textbutton _("Performance") action Preference("gl powersave", False)
                        textbutton _("Auto") action Preference("gl powersave", "auto")
                    
                    null height 10
                    vbox:
                        style_prefix "radio"
                        label _("GL Framerate")    
                        textbutton _("Display's Framerate") action Preference("gl framerate", None)
                        textbutton _("60") action Preference("gl framerate", 60)
                        textbutton _("30") action Preference("gl framerate", 30)
                        textbutton _("15") action Preference("gl framerate", 15)
                        textbutton _("5") action Preference("gl framerate", 5)
                    
                    null height 10
                    vbox:
                        style_prefix "radio"
                        label _("GL Tearing")
                        textbutton _("Skip Frames") action Preference("gl tearing", False)
                        textbutton _("Use Tearing") action Preference("gl tearing", True)
                    ...
                    vbox:
                        style_prefix "radio"
                        label _("Video Sprites")    
                        textbutton _("Show") action Preference("video sprites", "show")
                        textbutton _("Fall back to images") action Preference("video sprites", "hide")
...
style game_menu_na2vigation_frame:
    variant "small"
    xsize 340
