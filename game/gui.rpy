...
define gui.idle_small_color = "#8dd35f" #'#aaaaaa'

## The color that is used for buttons and bars that are hovered.
define gui.hover_color = "#8dd35f" #'#8dd35f'
...
define gui.muted_color = "#112119" # '#285100'
define gui.hover_muted_color = "#112119" #'#3d7a00'
...
define gui.default_font = "andvari.ttf"

## The font used for character names.
define gui.name_font = "andvari.ttf"

## The font used for out-of-game text.
define gui.interface_font = "andvari.ttf"

## The size of normal dialogue text.
define gui.text_size = 14 #34#14 #16

## The size of character names.
define gui.name_text_size = 30

## The size of text in the game's user interface.
define gui.interface_text_size = 15 #20

## The size of labels in the game's user interface.
define gui.label_text_size = 15 #20
...
define gui.textbox_height = 200 #185
...
define gui.choice_button_height = None #50
define gui.choice_button_tile =  True
#define gui.choice_button_borders = Borders(25, 5, 25, 5)
define gui.choice_button_borders = Borders(10, 20, 10, 20)
...
define config.history_length = 150#250

## The height of a history screen entry, or None to make the height variable at
## the cost of performance.
define gui.history_height = None#50 #140

## The position, width, and alignment of the label giving the name of the
## speaking character.
define gui.history_name_xpos = 0.0#150
define gui.history_name_ypos = 0
define gui.history_name_width = 130
define gui.history_name_xalign = 0.0

## The position, width, and alignment of the dialogue text.
define gui.history_text_xpos = 110#170
define gui.history_text_ypos = 0#5
define gui.history_text_width = 330#740
...
init python:
    ...
    if renpy.variant("touch2"):

        gui.quick_button_borders = Borders(40, 14, 40, 0)

    ## This changes the size and spacing of various GUI elements to ensure they
    ## are easily visible on phones.
    if renpy.variant("small2"):

        ## Font sizes.
        gui.text_size = 10 #30
        gui.name_text_size = 30 #36
        gui.notify_text_size = 15
        gui.interface_text_size = 10 #36
        gui.button_text_size = 10 #34
        gui.label_text_size = 20 #36
        ...
        gui.choice_button_width = 250 #1240
